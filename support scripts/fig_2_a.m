...
w = 400; ht = 200; % Define window size: width(w) and height(ht)
...
figure('name','Perivascular NO concentrations',...
...
legend([pt3 pt2 pt1],'uniform','regional','proximal')
axis square
